...
`https://api.betterdoctor.com/2016-03-01/doctors?query=${symptom}&location=45.505%2C-122.675%2C25&user_location=45.505%2C-122.675&skip=0&limit=100&user_key=${process.env.exports.apiKey}`
